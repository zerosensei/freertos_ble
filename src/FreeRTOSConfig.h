...
#define configMINIMAL_STACK_SIZE       ((unsigned short)126) /* Can be as low as 60 but some of the demo tasks that use this constant require it to be higher. */
...
header file. */
#define configASSERT_MSG(test, fmt, ...)                 \
    if ((test) == 0) {                     \
